 ...
 *
 * 520ms sits in the requested 500-650ms band. The curve is a pure
 * decelerating ease, not a spring: a spring overshoots, and a hardcover book
 * landing on a table does not bounce back up.
 */
...
/** Add-to-cart flight, ported from the supplied vanilla Motion example. */
